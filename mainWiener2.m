...
% Filtro de Wiener
wiener_signal = wienerFilter2(x_r, n);
...
% 
% sinal_reduzido = sinal_filtrado(1:5*Fs);
% sound(sinal_reduzido,Fs)
...
title('Espectro de Magnitude do Sinal de Áudio Filtrado Desconhecendo-se o Sinal Desejado');
